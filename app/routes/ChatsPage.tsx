...
export default function ChatsPage() {
  ...
  return (
    <div className="flex flex-col flex-1 bg-gray-300 w-full max-w-2xl mx-auto items-center px-4 sm:px-12 overflow-x-hidden">
      <h2 className="text-3xl font-bold text-left my-2 text-vibeon w-full">
        Your Chats
      </h2>

      <hr className="w-full my-2 border border-vibeon" />
      ...
      <div className="flex flex-col gap-2 w-full">
        {chats.map((chat) => (
          <Link
            ...
            key={chat.id}
            className="flex items-center p-2 rounded-2xl bg-gray-200 w-full min-w-0"
          >
            <img
